        ...
        return(
                    <Table striped bordered hover>
                        ...
                        <tr>
                            ...
                            <th class={"tabletView"}><p className={"tableFont"}>Known Change</p></th>
                            <th><p className={"tableFont"}>Malicious Change</p></th>
                            <th class={"pcView"}><p className={"tableFont"}>Acknowledged User</p></th>
                            <th class={"tabletView"}><p className={"tableFont"}>Acknowledged Time</p></th>
                        </tr>
                        </thead>
                        <tbody>
                        {
                                ...
                                .map(
                                    alert =>
                                        <tr key={alert.id}>
                                            ...
                                            <td class={"tabletView"}><p className={"tableFont"}>{alert.timestamp}</p></td>
                                            ...
                                            <td class={"tabletView"}><p class={"tableFont"}>{alert.acknowledge_time}</p></td>
                                        </tr>)
                        }
                        </tbody>
                    </Table>
