INSERT INTO `alert` (`id`, `application_id`, `change_agent`, `change_process`, `file`, `hostname`, `timestamp`, `checked`, `known`, `malicious`,`acknowledge_user`) VALUES (NULL, 500, 'hunter', 'update', 'README', 'localhost', current_timestamp(), 1, true, false, 'hunter');
