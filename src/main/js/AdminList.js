        ...
        return (
            <div>
                <Navbar bg="dark" variant="dark" width = "100%">
                    <p style={{fontSize: "10px"}}><Navbar.Brand href="/"> File System </Navbar.Brand>
                    <Navbar.Toggle /></p>
                    <Nav className="mr-auto">
                        <p style={{fontSize: "15px"}}><Nav.Link href="#unacknowledge" onSelect={this.unchecked.bind(this)} style={{marginRight: "10%"}}>Unacknowledged Alerts</Nav.Link></p>
                        <p style={{fontSize: "15px"}}><Nav.Link href="#acknowledge" onSelect={this.checked.bind(this)} style={{marginRight: "10%"}}>Acknowledged Alerts</Nav.Link></p>
                            <p style={{fontSize: "15px"}}><Nav.Link href="#filter" onSelect={this.filtered.bind(this)} style={{marginRight: "10%"}}>Red Alerts</Nav.Link></p>
                    </Nav>
                </Navbar>
